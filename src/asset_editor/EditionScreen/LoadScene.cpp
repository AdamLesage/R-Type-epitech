...
Edition::LoadScene::LoadScene(std::string& scenePath, std::vector<std::shared_ptr<Edition::Asset>> assets) {
    ...
    try {
        ...
        std::cerr << "Error from LoadScene constructor: " << e.what() << " for filename " << _scenePath
                  << std::endl;
    }
...
std::vector<std::shared_ptr<Edition::Asset>> Edition::LoadScene::load() {
    std::string emptyAssetPath =
        std::string("assets") + PATH_SEPARATOR + "asset_editor" + PATH_SEPARATOR + "empty.png";
...
void Edition::LoadScene::loadComponentSize(libconfig::Setting& components,
...
void Edition::LoadScene::loadComponentPosition(libconfig::Setting& components,
                                               std::shared_ptr<Edition::Asset> asset) {
    try {
...
void Edition::LoadScene::loadComponentRotation(libconfig::Setting& components,
                                               std::shared_ptr<Edition::Asset> asset) {
    try {
...
void Edition::LoadScene::loadComponentSprite(libconfig::Setting& components,
                                             std::shared_ptr<Edition::Asset> asset) {
    try {
