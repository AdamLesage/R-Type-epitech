...
namespace RType {
    class Console {
        public:
             ...
             */
            bool getDeveloperConsole() const {
                return _showDeveloperConsole;
            }

            /**
             * @brief Toggle the developer console visibility
             */
            void toggleDeveloperConsole() {
                _showDeveloperConsole = !_showDeveloperConsole;
            }
        ...
        private:
             ...
             *
             * Container is a black rectangle that contains the console with a specific size and opacity to
             * make it visible
             */
